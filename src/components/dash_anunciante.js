...
import ViewGrafico from './graphapi';
import Top10Transacciones from './anunciante/Top10Trans';

import axios from '../api/axios';
const ADVERTISERS_URL = '/advertisers/644c3254b469b5e444c4bb53/stats?start=2023-04-01&end=2023-05-30';

const DashAnunciante = () => {
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div id="afiliados-count" class="box_resumen">
                                        <span><b>{data.totalAffiliates}</b> <em>Total en un rango de 30 días.</em></span>
